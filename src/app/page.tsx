...
import { ArrowRight, ListOrdered, LucideTimer, Split } from "lucide-react"
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <section className="bg-gradient-to-b from-background flex items-center justify-center to-purple-50 dark:to-purple-950/20 py-20">
          <div className="container">
            <div className="mx-auto max-w-3xl text-center">
              <div className="inline-block rounded-lg bg-purple-100 dark:bg-purple-900/30 px-3 py-1 text-sm text-purple-800 dark:text-purple-300">
              ...
              <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                ...
                <Link
                  href="#"
                  className="inline-flex items-center justify-center gap-2 rounded-md border border-gray-300 bg-white dark:bg-gray-800 dark:border-gray-700 px-6 py-3 font-medium text-gray-700 dark:text-gray-200 transition-colors hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
                >
                  Learn More
                </Link>
              </div>
        ...
        <section className="py-20 flex items-center justify-center dark:bg-gray-950">
          <div className="container">
            <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-16 grid gap-8 md:grid-cols-3">
              <div className="rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-6 shadow-sm transition-all hover:shadow-md">
        ...
        <section className="flex items-center justify-center bg-purple-50 dark:bg-purple-950/20 py-20" id="about">
          <div className="container">
            <div className="mx-auto max-w-3xl text-center">
              <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl">
